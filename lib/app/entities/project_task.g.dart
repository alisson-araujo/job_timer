...
const ProjectTaskSchema = CollectionSchema(
  name: 'ProjectTask',
  schema:
      '{"name":"ProjectTask","idName":"id","properties":[{"name":"created","type":"Long"},{"name":"duraction","type":"Long"},{"name":"name","type":"String"}],"indexes":[],"links":[]}',
  idName: 'id',
  propertyIds: {'created': 0, 'duraction': 1, 'name': 2},
  listProperties: {},
  indexIds: {},
  indexValueTypes: {},
  linkIds: {},
...
void _projectTaskSerializeNative(
  ...
  final value1 = object.duraction;
  final _duraction = value1;
  ...
  writer.writeLong(offsets[1], _duraction);
...
ProjectTask _projectTaskDeserializeNative(
  ...
  object.duraction = reader.readLong(offsets[1]);
  object.id = id;
...
dynamic _projectTaskSerializeWeb(
  ...
  IsarNative.jsObjectSet(jsObj, 'duraction', object.duraction);
...
ProjectTask _projectTaskDeserializeWeb(
  ...
  object.duraction =
      IsarNative.jsObjectGet(jsObj, 'duraction') ?? double.negativeInfinity;
...
P _projectTaskDeserializePropWeb<P>(Object jsObj, String propertyName) {
  switch (propertyName) {
    ...
    case 'duraction':
      return (IsarNative.jsObjectGet(jsObj, 'duraction') ??
...
extension ProjectTaskQueryWhereSortBy
  ...
  QueryBuilder<ProjectTask, ProjectTask, QAfterSortBy> sortByDuraction() {
    return addSortByInternal('duraction', Sort.asc);
  }

  QueryBuilder<ProjectTask, ProjectTask, QAfterSortBy> sortByDuractionDesc() {
    return addSortByInternal('duraction', Sort.desc);
  }
...
extension ProjectTaskQueryWhereSortThenBy
  ...
  QueryBuilder<ProjectTask, ProjectTask, QAfterSortBy> thenByDuraction() {
    return addSortByInternal('duraction', Sort.asc);
  }

  QueryBuilder<ProjectTask, ProjectTask, QAfterSortBy> thenByDuractionDesc() {
    return addSortByInternal('duraction', Sort.desc);
  }
...
extension ProjectTaskQueryWhereDistinct
  ...
  QueryBuilder<ProjectTask, ProjectTask, QDistinct> distinctByDuraction() {
    return addDistinctByInternal('duraction');
  }
...
extension ProjectTaskQueryProperty
  ...
  QueryBuilder<ProjectTask, int, QQueryOperations> duractionProperty() {
    return addPropertyNameInternal('duraction');
  }
